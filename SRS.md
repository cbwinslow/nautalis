...
**Version**: 1.0.0  
**Status**: Draft — Design Complete, Implementation In Progress (~60% complete)  
**Date**: 2026-04-03  
**Implementation Status:** See [IMPLEMENTATION_STATUS.md](./IMPLEMENTATION_STATUS.md)

⚠️ **Important Note:** This SRS represents the full intended feature set. The project is currently in early alpha with significant implementation gaps. An MVP scope (30% of requirements) is being defined in GitHub issue #42. See [PROJECT_SUMMARY.md](./PROJECT_SUMMARY.md) for current status and timeline.
...
| `NAUTALIS_OPENAI_API_KEY`     | OpenAI API key             | _(none)_                  |
