...
- **Interactive Setup Wizard** — `nautalis setup` guides users through configuration with prompts for database, embeddings, LLM, and connectors; writes `.nautalisrc.json`.
